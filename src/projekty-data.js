export const projektyData = [
  {
    ...
    challenge: "Stan deweloperski. Ze względu na narożny układ kamienicy zastany jest nietypowy układ ścian. Punkty mediów narzucają niekorzystny układ dla projektu pomieszczenia. Prysznic miał powstać w nietypowym miejscu, technicznie trudnym do realizacji. Dwie mokre strefy.",
  ...
  },
  {
    ...
    challenge: "Niewielka kuchnia, wymagająca remontu. Ograniczona ścianami nośnymi. Punkty wody i pralka muszą zostać na swoim miejscu. Bardzo niski budżet. Niewielka przestrzeń robocza. Pralka musi zostać. Odzyskiwanie starych materiałów i mebli. Odmalowanie kafli",
  ...
  },
  {
    ...
    challenge: "Przestronny dom z chaotycznym układem funkcjonalnym i niewykorzystanym potencjałem elewacji południowo-zachodniej. Nieprawidłowo zaprojektowana strefa dzienna i jej doświetlenie. Wątpliwości co do możliwości i zasadności dobudowania wiaty garażowej w przyszłości.",
  ...
  },
  {
    ...
    challenge: "Rodzina z dwójką dzieci zmagała się z ciągłym bałaganem i brakiem miejsca na rzeczy codziennego użytku. Pomieszczenia były źle zorganizowane - duży salon był rzadko używany, podczas gdy strefa dzienna była zbyt mała.",
    solution: "Przeprojektowaliśmy strefy funkcjonalne domu. Stworzyliśmy większą i bardziej praktyczną kuchnię z jadalnią. Zaprojektowaliśmy dedykowaną przestrzeń do nauki dla dzieci i dodaliśmy inteligentne systemy przechowywania w każdej strefie. Dodaliśmy przestrzenie magazynowe z nieuczęszczanych stref komunikacji.",
    result: "Mieszkanie stało się przyjazne dla całej rodziny. Każdy członek rodziny ma swoją przestrzeń, a równocześnie strefa wspólna sprzyja spędzaniu czasu razem. Właściciele podkreślają, że wreszcie czują się komfortowo we własnym domu.",
